  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: [
        ...
        Text(
          "Create Habits & Follow them ",
          style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
        ),
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Text(
            "Take control of your daily habits and watch your progress soar with LifePilot, designed to help you cultivate a life of success and fulfillment",
            maxLines: 4,
