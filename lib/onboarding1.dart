    ...
    return Scaffold(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            "Streamline your tasks, harness your focus, and achieve remarkable result with LifePilot, the all-in-one solution for organizing your life and maximizing your productivity",
            maxLines: 4,
        ...
        GestureDetector(
          onTap: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (_) => OnBoarding2()));
          },
          child: Align(
